...
function reset() {
    ...
    const life = '♆'
    elLifeCountDisplay.innerHTML = life.repeat(3)

    const elShieldCountDisplay = document.querySelector('.shield-count')
    const shield = '🛡️'
    elShieldCountDisplay.innerHTML = shield.repeat(3)
